...
{
	printf("Blind Point Spread Function Estimation from a Random Target\n");
	printf("Copyright M.Delbracio, A.Almansa, P.Muse and JM. Morel. Version Beta 0.1" __DATE__ "\n\n");
	...
	for(i = 1; i < argc;)
	{
		if(argv[i] && argv[i][0] == '-')
		{
			   ...
			   int main(int argc, char *argv[])
			{
				...
				/* Call psf_estimation */
				blind_psf_estim(img_zout,  nx_zout,  ny_zout, img_zin,  nx_zin, ny_zin,
